...
parser.add_argument(
    "--tune",
    nargs="*",
    help="Config parameters to tune, " "which have list of possible values to check",
)
...
if __name__ == "__main__":
    ...
    for i, h_params in enumerate(
        product(*[product([param], config[param]) for param in args_to_tune])
    ):
